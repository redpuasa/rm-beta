...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@egc.gov.bn";
    ...
    * @var string
    */
	protected $baseDn = "DC=egc,DC=gov,DC=bn"; 
    ...
    * @var array
    */
    protected $domainControllers = array("10.241.19.11", "10.241.19.12"); // 10.240.31.90, 10.240.31.91
